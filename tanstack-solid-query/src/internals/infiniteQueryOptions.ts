import type { DataTag, QueryClient, QueryFunction, SkipToken } from '@tanstack/solid-query';
import { infiniteQueryOptions, skipToken } from '@tanstack/solid-query';
import type {
  SolidDefinedInitialDataInfiniteOptions,
  SolidUndefinedInitialDataInfiniteOptions,
  SolidUnusedSkipTokenInfiniteOptions,
} from './solidQueryTypes';
...
>(args: {
  ...
  return Object.assign(
    ...
    } as Parameters<typeof infiniteQueryOptions>[0]),
